...
CFLAGS		=	-g -Wall -Werror -ffreestanding -nostdlib -fno-stack-protector -fno-strict-aliasing -O2 -D$(chiplet) -D$(mem_mode) -D$(chiplet_die_available) -D$(platform_cluster_x_core) -DENABLE_VPU_SDK=$(ENABLE_VPU_SDK) -DENABLE_ECC=$(ENABLE_ECC)
ifneq ($(DEBUG),)
CFLAGS		+=	-O0
else
CFLAGS		+=	-O2
